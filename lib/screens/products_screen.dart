...
class _ProductsScreenState extends State<ProductsScreen> {
  ...
  final Map<String, List<Map<String, dynamic>>> productsByCategory = {
    'Vegetables': [
      ...
      {'name': 'Beetroot','image': 'assets/images/beetroot.jpg','price': 120.00,},
      {'name': 'Brinjal','image': 'assets/images/brinjal.jpg','price': 110.00},
    ...
    'Fruits': [
      ...
      {'name': 'Pineapple','image': 'assets/images/pineapple.jpg','price': 180.00},
      {'name': 'Strawberry','image': 'assets/images/strawberry.jpg','price': 350.00},
      {'name': 'Watermelon','image': 'assets/images/watermelon.jpg','price': 250.00},
    ],
    'Dairy Products': [
      ...
      {'name': 'Freshmilk','image': 'assets/images/freshmilk.jpg','price': 18.00},
      {'name': 'Icecream','image': 'assets/images/icecream.jpg','price': 300.00,},
      {'name': 'Chocolate Milk Packet','image': 'assets/images/milkpacket.jpg','price': 180.00},
      {'name': 'Vanilla Milk Packet','image': 'assets/images/vanilla.jpg','price': 220.00},
      {'name': 'Yogurt', 'image': 'assets/images/yogurt.jpg', 'price': 90.00},
    ],
    'Fresh Meat': [
      {'name': 'Beef', 'image': 'assets/images/beef.jpg', 'price': 950.00},
      {'name': 'Boneless Chicken','image': 'assets/images/bonelesschick.jpg','price': 800.00},
      {'name': 'Chicken','image': 'assets/images/chicken.jpg','price': 750.00,},
      {'name': 'Chicken Leg','image': 'assets/images/chickenleg.jpg','price': 700.00},
      {'name': 'Fish', 'image': 'assets/images/fish.jpg', 'price': 1200.00},
      {'name': 'Pork', 'image': 'assets/images/pork.jpg', 'price': 850.00},
      {'name': 'Pork Sausages','image': 'assets/images/porksau.jpg','price': 480.00},
      {'name': 'Sausages','image': 'assets/images/sausages.jpg','price': 450.00},
    ],
    'Beverages': [
      {'name': 'Coca-cola','image': 'assets/images/cocacola.jpg','price': 180.00},
      {'name': 'Cream Soda','image': 'assets/images/creamsoda.jpg','price': 150.00},
      ...
      {'name': 'Redbull','image': 'assets/images/redbull.jpg','price': 350.00},
      {'name': 'Sprite', 'image': 'assets/images/sprite.jpg', 'price': 180.00},
      {'name': 'Suncrush','image': 'assets/images/suncrush.jpg','price': 150.00},
    ],
    'Beauty Products': [
      {'name': 'Ayush Facewash','image': 'assets/images/ayush.jpg','price': 240.00},
      {'name': 'Skin Toner','image': 'assets/images/toner.jpg','price': 600.00},
      {'name': 'Face Cream','image': 'assets/images/cream.jpg','price': 350.00},
      {'name': 'Mens Facewash','image': 'assets/images/facewash.jpg','price': 400.00},
      {'name': 'Lipbalm','image': 'assets/images/lipbalm.jpg','price': 200.00},
      {'name': 'Glow and Lovely','image': 'assets/images/love.jpg','price': 500.00},
      {'name': 'Vivya Facewash','image': 'assets/images/pure.jpg','price': 450.00},
    ],
  };
